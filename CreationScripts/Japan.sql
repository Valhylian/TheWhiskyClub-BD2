USE [master]
GO
/****** Object:  Database [WhiskyJapan]    Script Date: 6/15/2022 7:28:20 PM ******/
CREATE DATABASE [WhiskyJapan]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'WhiskyJapan', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\WhiskyJapan.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'WhiskyJapan_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\WhiskyJapan_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT
GO
ALTER DATABASE [WhiskyJapan] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [WhiskyJapan].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [WhiskyJapan] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [WhiskyJapan] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [WhiskyJapan] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [WhiskyJapan] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [WhiskyJapan] SET ARITHABORT OFF 
GO
ALTER DATABASE [WhiskyJapan] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [WhiskyJapan] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [WhiskyJapan] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [WhiskyJapan] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [WhiskyJapan] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [WhiskyJapan] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [WhiskyJapan] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [WhiskyJapan] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [WhiskyJapan] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [WhiskyJapan] SET  DISABLE_BROKER 
GO
ALTER DATABASE [WhiskyJapan] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [WhiskyJapan] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [WhiskyJapan] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [WhiskyJapan] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [WhiskyJapan] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [WhiskyJapan] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [WhiskyJapan] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [WhiskyJapan] SET RECOVERY FULL 
GO
ALTER DATABASE [WhiskyJapan] SET  MULTI_USER 
GO
ALTER DATABASE [WhiskyJapan] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [WhiskyJapan] SET DB_CHAINING OFF 
GO
ALTER DATABASE [WhiskyJapan] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [WhiskyJapan] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [WhiskyJapan] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [WhiskyJapan] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'WhiskyJapan', N'ON'
GO
ALTER DATABASE [WhiskyJapan] SET QUERY_STORE = OFF
GO
USE [WhiskyJapan]
GO
/****** Object:  Table [dbo].[CatalogContainer]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CatalogProductType]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CatalogSubscription]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Client]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Product]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductxStore]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[purchase]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[purchase](
 ...
 CONSTRAINT [PK__purchase__84A464F91B694BB8] PRIMARY KEY CLUSTERED 
(
	[id_purchase] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [dbo].[purchaseXProduct]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[purchaseXProduct](
	...
	[amount] [int] NOT NULL,
	[subtotal] [money] NOT NULL,
 CONSTRAINT [PK__purchase__393FB097EB7CDC0A] PRIMARY KEY CLUSTERED 
(
	[id_purchaseXProduct] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Store]    Script Date: 6/15/2022 7:28:20 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Store] ([id_store], [name_store], [location_store]) VALUES (4, N'WhiskyClub Japan 1', 0xE6100000010CA7E4B3FDF2D54140AE60160B70786140)
GO
INSERT [dbo].[Store] ([id_store], [name_store], [location_store]) VALUES (5, N'WhiskyClub Japan 2', 0xE6100000010CCB323EE063DC414026BBDF2999766140)
GO
INSERT [dbo].[Store] ([id_store], [name_store], [location_store]) VALUES (6, N'WhiskyClub Japan 3', 0xE6100000010C642141698FD54140A129D96D73786140)
GO
...
USE [master]
GO
ALTER DATABASE [WhiskyJapan] SET  READ_WRITE 
GO
