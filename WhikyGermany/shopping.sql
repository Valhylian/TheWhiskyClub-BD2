ALTER PROCEDURE [dbo].[generatePurchase]
...
DECLARE @jsonShopping VARCHAR(128)= '[{"idProduct":3,"quantity":10},{"idProduct":2,"quantity":1}]'

EXEC generatePurchase
@jsonProducts_ = @jsonShopping,
@idStore_ = 3,
@idClient_  =1
